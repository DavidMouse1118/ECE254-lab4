...
int main(int argc, char *argv[])
{
	...
	if ( algo == 0 ) {
		...
		while(1){
			//Alloc
			void* best_block[8];
			best_block[0] =	best_fit_alloc((size_t)(rand() % 1024 + 1));
			if (best_block[0] == NULL) {  break; }
			best_block[1] =	best_fit_alloc((size_t)(rand() % 1024 + 1));
			if (best_block[1] == NULL) {  break; }
			best_block[2] =	best_fit_alloc((size_t)(rand() % 1024 + 1));
			if (best_block[2] == NULL) {  break; }
			best_block[3] =	best_fit_alloc((size_t)(rand() % 1024 + 1));
			if (best_block[3] == NULL) {  break; }
			best_block[4] =	best_fit_alloc((size_t)(rand() % 1024 + 1));
			if (best_block[4] == NULL) {  break; }
			best_block[5] =	best_fit_alloc((size_t)(rand() % 1024 + 1));
			if (best_block[5] == NULL) {  break; }
			best_block[6] =	best_fit_alloc((size_t)(rand() % 1024 + 1));
			if (best_block[6] == NULL) {  break; }
			best_block[7] =	best_fit_alloc((size_t)(rand() % 1024 + 1));
		...
		printf("The external fragmentation memory blocks less than 1024 bytes is %d\n", best_fit_count_extfrag(1024));
...
// printf("the extern frag for best fit for 256 bytes is %d\n", twofiftysix_bf);
		...
		while(1){
			//Alloc
			void* worst_block[8];
			worst_block[0] = worst_fit_alloc((size_t)(rand() % 1024 + 1));
			if (worst_block[0] == NULL) {  break; }
			worst_block[1] = worst_fit_alloc((size_t)(rand() % 1024 + 1));
			if (worst_block[1] == NULL) {  break; }
			worst_block[2] = worst_fit_alloc((size_t)(rand() % 1024 + 1));
			if (worst_block[2] == NULL) {  break; }
			worst_block[3] = worst_fit_alloc((size_t)(rand() % 1024 + 1));
			if (worst_block[3] == NULL) {  break; }
			worst_block[4] = worst_fit_alloc((size_t)(rand() % 1024 + 1));
			if (worst_block[4] == NULL) {  break; }
			worst_block[5] = worst_fit_alloc((size_t)(rand() % 1024 + 1));
			if (worst_block[5] == NULL) {  break; }
			worst_block[6] = worst_fit_alloc((size_t)(rand() % 1024 + 1));
			if (worst_block[6] == NULL) {  break; }
			worst_block[7] = worst_fit_alloc((size_t)(rand() % 1024 + 1));
